...
const QuickReport = () => {
  ...
  const {
    todaysSells = "1,234",
    lastSevenDaysSells = "8,567",
    lastThirtyDaysSells = "25,678",
    lastOneYearSells = "123,456",
  } = data;
      ...
      {loading ? (
        ...
        <>
          <div className="invention-quickreport-area pl-0.5">
            <div className="pt-5 pb-2 mb-5 bg-white rounded-lg cashier-quickview-area p-7">
              ...
              <div className="flex items-center justify-between cashier-quickview-wrapper gap-x-5 maxXs:gap-x-0">
                <div className="cashier-quickview bg-[#EEF0F8] mb-5 rounded-lg">
                  <Link href="" className="p-[30px] inline-block">
                    <div className="cashier-quickview-box">
                      <div className="mb-5 cashier-quickview-box-icon">
                        <Image
